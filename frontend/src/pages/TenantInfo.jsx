export default function TenantInfo(){
    ...
    <div className="animate-fadeInUp select-none cursor-default">
        ...
        <div>
            <p className="justify-center text-center text-white max-w-md text-xl mb-8 mt-4 ml-125">
            Firma y gestiona tus contratos de renta de forma segura, 
            sin intermediarios y con verificación en la blockchain.
            </p>

            <p className="mt-6 text-white max-w-2xl mx-auto leading-relaxed mr-100">
            ...
            <ul className="mt-8 text-gray-300 space-y-2 text-left ml-105">
        ...
        <div className="flex justify-between items-center w-full px-20 -mt-85">
        <img 
        ...
        <img 
            ...
            alt="Arrendador2 Img"
            className="w-80 h-auto object-contain -mr-10"
        />
        </div>
